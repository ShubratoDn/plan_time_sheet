CREATE TABLE master_timesheet.company (
...
CREATE TABLE master_timesheet.`user` (
...
CREATE TABLE master_timesheet.`user_company` (
...
CREATE TABLE master_timesheet.`permission_plan` (
                                   `id` int(11) NOT NULL AUTO_INCREMENT,
                                   `company_id` int(11) DEFAULT NULL,
...
CREATE TABLE master_timesheet.`otp_token` (
